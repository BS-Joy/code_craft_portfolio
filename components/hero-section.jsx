      ...
      <div className='container relative z-10 px-4 md:px-6'>
        <div className='grid gap-12 md:grid-cols-2 md:gap-16'>
          <div className='flex flex-col justify-center space-y-4'>
            ...
            <div className='flex flex-wrap items-center gap-4 text-lg text-gray-500 dark:text-gray-400'>
              <div className='flex items-center'>
                <Bot className='mr-1 h-6 w-6 text-purple-600 dark:text-purple-400' />
                <span>AI Chatbots</span>
              </div>
              <div className='flex items-center'>
                <Code className='mr-1 h-6 w-6 text-purple-600 dark:text-purple-400' />
                <span>GPT Integration</span>
              </div>
              <div className='flex items-center'>
                <MessageSquare className='mr-1 h-6 w-6 text-purple-600 dark:text-purple-400' />
                <span>Mobile Apps</span>
              </div>
              <div className='flex items-center'>
                <Cpu className='mr-1 h-6 w-6 text-purple-600 dark:text-purple-400' />
